...
namespace ACME
{
    ...
    public class CameraSlider : UISlider
    {
        ...
        /// <summary>
        /// Sets the minimum slider step size; underlying step size is 1/10th of value, to ensure small changes aren't quantized out.
        /// </summary>
        public float StepSize { set => stepSize = value / 10f; }

        /// <summary>
        /// Gets the current mouse wheel step multiplier based on modifier key states.
