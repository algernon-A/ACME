// <copyright file="CameraOptions.cs" company="algernon (K. Algernon A. Sheppard)">
...
namespace ACME
{
    ...
    internal class CameraOptions
    {
        ...
        {
            // Add tab.
            UIPanel panel = UITabstrips.AddTextTab(tabStrip, Translations.Translate("CAM_OPT_CAM"), tabIndex, out UIButton _, autoLayout: false);
